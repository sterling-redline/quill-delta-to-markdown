...
module.exports = function convert(ops, converters) {
    ...
    function applyInlineAttributes(attrs, next) {
      ...
      function apply(fmt) {
        //console.log ('Inline apply', {fmt, a: attrs[fmt], c: converters.inline[fmt].call(attrs[fmt])});
